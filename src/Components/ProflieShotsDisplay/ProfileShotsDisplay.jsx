...
const ProfileShotsDisplay = () => {
	return (
		<div className="grid grid-cols-1 md:grid-cols-3 grid-flow-row gap-1 md:gap-2 lg:gap-4 lg:ml-20">
			<div>
				<img
...
export default ProfileShotsDisplay;
